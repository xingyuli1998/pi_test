...
def index(): 
    while True: 
        ...
        return render_template('index.html',fname = fname, lname = lname, planttype = planttype )
...
def index():
    while True:
        ...
        return render_template('index.html',hum_value = hum_value,tem_value = tem_value,time_value = timeNow ) #you can customze index.html here
